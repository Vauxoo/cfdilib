...
class TestCfdilib(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.real_document_xml = join(dirname(cfdilib.__file__), "..", "tests", "demo", 'cfdv32.xml')
    ...
    def test_006_download_file(self):
        """With a file it is downloaded and cached in a temporary file"""  # TODO: Mock this
        ...
        self.assertTrue(content.find('se establece que la salida') > 0,
                        'I read the content of a cached file and the result was not correct.')
